...
void TypeSolver::generateConstraints() {
    ...
    public:
        ...
        // first run through)
        ConstraintFinder(TypeLattice* lattice, TypeSolver* solver, const AstProgram* program)
                : lattice(lattice), solver(solver), program(program) {}
    ...
    ConstraintFinder(lattice, this, program).visit(*clause);
}
