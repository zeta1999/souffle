...
LVMRelation::LVMRelation(std::size_t arity, std::size_t numberOfHeights, const std::string& name,
...
size_t LVMRelation::getNumberOfHeights() const {
    return this->numberOfHeights;
}
...
LVMEqRelation::LVMEqRelation(size_t arity, size_t numberOfHeights, const std::string& name,
        const std::vector<std::string>& attributeTypes, const MinIndexSelection& orderSet)
        : LVMRelation(arity, numberOfHeights, name, attributeTypes, orderSet) {}
...
LVMIndirectRelation::LVMIndirectRelation(size_t arity, size_t numberOfHeights, const std::string& name,
        const std::vector<std::string>& attributeTypes, const MinIndexSelection& orderSet)
        : LVMRelation(arity, numberOfHeights, name, attributeTypes, orderSet, createIndirectIndex) {}
