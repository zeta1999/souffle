...
SignalHandler::instance()->setMsg(R"_(path(X,Y) :- 
   edge(X,Y).
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/insert_for/insert_for.dl [7:1-7:24])_");
if(!(rel_1_edge->empty())) {
[&](){
...
SignalHandler::instance()->setMsg(R"_(path(X,Y) :- 
   path(X,Z),
   edge(Z,Y).
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/insert_for/insert_for.dl [6:1-6:35])_");
...
{
try{
souffle::CmdOptions opt(R"(swig/python/insert_for/insert_for.dl)",
R"(.)",
R"(.)",
false,
R"()",
