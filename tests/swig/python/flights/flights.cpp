...
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/flights/flights.dl [20:1-20:25])_");
rel_1_flight->insert(RamDomain(0),RamDomain(2),RamDomain(4));
SignalHandler::instance()->setMsg(R"_(flight("QA","JPN","DEN").
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/flights/flights.dl [21:1-21:26])_");
rel_1_flight->insert(RamDomain(0),RamDomain(4),RamDomain(5));
SignalHandler::instance()->setMsg(R"_(flight("QA","JPN","CHI").
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/flights/flights.dl [22:1-22:26])_");
rel_1_flight->insert(RamDomain(0),RamDomain(4),RamDomain(3));
SignalHandler::instance()->setMsg(R"_(flight("QA","AU","CHI").
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/flights/flights.dl [23:1-23:25])_");
rel_1_flight->insert(RamDomain(0),RamDomain(2),RamDomain(3));
SignalHandler::instance()->setMsg(R"_(flight("VA","AU","CHI").
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/flights/flights.dl [24:1-24:25])_");
rel_1_flight->insert(RamDomain(1),RamDomain(2),RamDomain(3));
SignalHandler::instance()->setMsg(R"_(flight("VA","JPN","ZA").
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/flights/flights.dl [25:1-25:25])_");
rel_1_flight->insert(RamDomain(1),RamDomain(4),RamDomain(6));
SignalHandler::instance()->setMsg(R"_(flight("VA","JPN","DEN").
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/flights/flights.dl [26:1-26:26])_");
rel_1_flight->insert(RamDomain(1),RamDomain(4),RamDomain(5));
SignalHandler::instance()->setMsg(R"_(flight("VA","DEN","ZA").
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/flights/flights.dl [27:1-27:25])_");
...
SignalHandler::instance()->setMsg(R"_(QAflies(X,Y) :- 
   flight("QA",X,Y).
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/flights/flights.dl [11:1-11:34])_");
...
SignalHandler::instance()->setMsg(R"_(QAflies(X,Y) :- 
   flight("QA",X,Z),
   QAflies(Z,Y).
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/flights/flights.dl [12:1-12:48])_");
...
SignalHandler::instance()->setMsg(R"_(VAflies(X,Y) :- 
   flight("VA",X,Y).
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/flights/flights.dl [14:1-14:34])_");
if(!(rel_1_flight->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_1_flight_op_ctxt,rel_1_flight->createContext());
...
SignalHandler::instance()->setMsg(R"_(VAflies(X,Y) :- 
   flight("VA",X,Z),
   VAflies(Z,Y).
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/flights/flights.dl [15:1-15:48])_");
...
SignalHandler::instance()->setMsg(R"_(QAonly(X,Y) :- 
   QAflies(X,Y),
   !VAflies(X,Y).
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/flights/flights.dl [17:1-17:45])_");
...
{
try{
souffle::CmdOptions opt(R"(swig/python/flights/flights.dl)",
R"(.)",
R"(.)",
false,
R"()",
