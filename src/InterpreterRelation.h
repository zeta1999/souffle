...
public:
     ...
     */
    InterpreterRelation(std::size_t arity, const std::string& name, const std::vector<std::string>& attributeTypes,
...
public:
    InterpreterEqRelation(size_t arity, const std::string& relName, const std::vector<std::string>& attributeTypes,
