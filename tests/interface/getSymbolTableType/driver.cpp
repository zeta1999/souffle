...
int main(int argc, char** argv) {
    ...
    // create instance of program "getSymbolTableType"
    if (SouffleProgram* prog = ProgramFactory::newInstance("getSymbolTableType")) {
        ...
        error("cannot find program getSymbolTableType");
    }
