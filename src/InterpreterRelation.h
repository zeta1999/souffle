...
public:
    InterpreterEqRelation(size_t arity, size_t numberOfHeights, const std::string& relName,
...
public:
    InterpreterIndirectRelation(size_t arity, size_t numberOfHeights, const std::string& relName,
            const std::vector<std::string>& attributeTypes, const MinIndexSelection& orderSet);
    /** Insert tuple */
