...
public:
     ...
     */
    InterpreterRelation(std::size_t arity, std::size_t numAuxAttributes, std::string name,
...
public:
    InterpreterEqRelation(size_t arity, size_t numAuxAttributes, const std::string& relName,
...
public:
    InterpreterIndirectRelation(size_t arity, size_t numAuxAttributes, const std::string& relName,
            const std::vector<std::string>& attributeTypes, const MinIndexSelection& orderSet);
    /** Insert tuple */
