...
/************************************************************************
 *
 * @file LVMInterpreter.cpp
 *
 * Implementation of Souffle's LVM interpreter.
 *
 ***********************************************************************/

#include "LVMInterpreter.h"
#include "BTree.h"
...
void LVMInterpreter::executeMain() {
...
void LVMInterpreter::execute(std::unique_ptr<LVMCode>& codeStream, InterpreterContext& ctxt, size_t ip) {
