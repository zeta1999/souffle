...
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/paths/paths.dl [13:1-13:15])_");
rel_1_edge->insert(RamDomain(0),RamDomain(1));
SignalHandler::instance()->setMsg(R"_(edge("a","c").
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/paths/paths.dl [14:1-14:15])_");
rel_1_edge->insert(RamDomain(0),RamDomain(2));
SignalHandler::instance()->setMsg(R"_(edge("b","a").
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/paths/paths.dl [15:1-15:15])_");
rel_1_edge->insert(RamDomain(1),RamDomain(0));
SignalHandler::instance()->setMsg(R"_(edge("b","d").
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/paths/paths.dl [16:1-16:15])_");
...
SignalHandler::instance()->setMsg(R"_(path(X,Y) :- 
   edge(X,Y).
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/paths/paths.dl [19:1-19:24])_");
if(!(rel_1_edge->empty())) {
[&](){
...
SignalHandler::instance()->setMsg(R"_(path(X,Y) :- 
   path(X,Z),
   edge(Z,Y).
in file /mnt/c/Users/lnimn/Videos/stufflisa/school/uni/YR3SEM2/COMP3888/CAPSTONE/project19-group5/souffle/tests/swig/python/paths/paths.dl [18:1-18:35])_");
