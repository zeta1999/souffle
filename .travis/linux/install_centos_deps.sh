...
# Build dependencies
travis_retry yum install -y -q autoconf automake bison clang doxygen flex gcc gcc-c++ git java-11-openjdk kernel-devel libffi-devel libtool make mcpp ncurses-devel python python3 java sqlite sqlite-devel sudo zlib-devel
